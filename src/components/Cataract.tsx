        ...
        <div className="bg-[#1e1b4b] rounded-2xl shadow-xl p-8 md:p-10 mb-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 text-lg max-w-3xl leading-relaxed opacity-90">
              The images in this dataset were collected for the development of
              Roshni, an Artificial Intelligence based primary cataract
              screening tool. The images were taken with the consent of patients
              visited eye hospitals.
            </p>
          </div>
        </div>
            ...
            <section className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-12">
                  <SpecItem label="Total Volume" value="1000 Images" />
                  {/* <SpecItem label="File Format" value="*.jpg" /> */}
                  <SpecItem label="Image Size" value="Average 250 KB" />
                  <SpecItem label="Color Space" value="RGB" />
                  <SpecItem
                    label="Capture Method"
                    value="Smartphones (Samsung Galaxy A12)"
                  />
                </div>
              </div>
            </section>
                  ...
                  <div className="overflow-hidden border border-slate-200 rounded-lg">
                    <table className="min-w-full divide-y divide-slate-200">
                      ...
                      <tbody className="bg-white divide-y divide-slate-200">
                        <MetadataRow
                          field="Cataract Type"
                          desc="Immature Cataract (200) / Mature Cataract (300) / IOL Inserted (150) / No Cataract (350)"
                        />
                        <MetadataRow field="Image Quality" desc="Good" />
                        <MetadataRow
                          field="Patient Age Group"
                          desc="≥ 50 years (anonymized, no personal data)"
                        />
                      </tbody>
                    </table>
                  </div>
                  ...
                  <table className="min-w-full text-sm text-left text-slate-600">
                    <thead className="bg-slate-900 text-xs uppercase font-semibold text-slate-200">
                      <tr>
                        ...
                        <th className="px-6 py-3">Cataract Type</th>
                      </tr>
                    </thead>
            ...
            <section className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-4 p-3 bg-amber-50 border border-amber-100 rounded-lg">
                  ...
                  <a
                    href="https://colab.research.google.com/drive/17nmx5CpD6R7Pz5kABwMqnlVaUUimB0iA?usp=sharing"
                    target="_blank"
              ...
              <div className="flex items-start gap-4">
                <div>
                  ...
                  <p className="text-sm text-red-800 leading-relaxed mb-3">
                    <strong>You must prepare your own cataract dataset</strong>{" "}
